const fs = require("fs");
const pt = require("./core-gm-rules-pt.js");
...
const PAGE = "3.02 - The Game Masters Rules";
const checkOnly = process.argv.includes("--check");
if (pt.length !== 394) throw new Error(`Incomplete official text: ${pt.length}/394 nodes.`);
