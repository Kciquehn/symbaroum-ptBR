const fs = require("fs");
const pt = require("./core-apg-alternative-rules-pt.js");
...
const PAGE = "2.11 - APG - Alternative Rules";
const checkOnly = process.argv.includes("--check");
if (pt.length !== 689) throw new Error(`Incomplete official text: ${pt.length}/689 nodes.`);
